 ...
 * @author LENOVO
 */
public class PreguntaQuin extends javax.swing.JFrame {

    /**
     * Creates new form PreguntaQuin
     */
    public PreguntaQuin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelRectTranslucido1.setColorDeBorde(new java.awt.Color(255, 255, 0));
        panelRectTranslucido1.setColorDeSegundoBorde(new java.awt.Color(255, 51, 0));
        panelRectTranslucido1.setColorPrimario(new java.awt.Color(0, 204, 153));
        panelRectTranslucido1.setColorSecundario(new java.awt.Color(51, 51, 51));

        panelTranslucido1.setBackground(new java.awt.Color(0, 0, 0));
        panelTranslucido1.setColorPrimario(new java.awt.Color(0, 0, 0));
        panelTranslucido1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imag/santuario.jpeg"))); // NOI18N
        ...
        jLabel1.setText("5. ¿Cuál es un lugar turistico de SANTO DOMINGO DE LOS TSACHILAS?");
